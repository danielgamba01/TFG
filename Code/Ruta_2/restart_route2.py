...
spawn_point_walker_1=carla.Transform(carla.Location(x=12.8,y=-34.2,z=2.0),carla.Rotation(pitch=0.0, yaw=-90.0, roll=0.0))
spawn_point_walker_2= carla.Transform(carla.Location(x=93.0,y=-70.2,z=10.0),carla.Rotation(pitch=0.0, yaw=0.0, roll=0.0))
spawn_point_walker_3= carla.Transform(carla.Location(x=93.0,y=-69.2,z=10.0),carla.Rotation(pitch=0.0, yaw=0.0, roll=0.0))
spawn_point_walker_4= carla.Transform(carla.Location(x=-15.5,y=118.0,z=2.0),carla.Rotation(pitch=0.0, yaw=-90.0, roll=0.0))
spawn_point_walker_5= carla.Transform(carla.Location(x=-15.5,y=115.0,z=2.0),carla.Rotation(pitch=0.0, yaw=-90.0, roll=0.0))
